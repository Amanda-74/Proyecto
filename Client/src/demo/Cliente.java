...
public class Cliente {
	...
	public static void main(String[] args) {
		...
		rt.postForObject("http://192.168.12.128:8080/MavenSpring/usrs/crear", u, String.class);
		
		//Usuarios u = rt.getForObject("http://192.168.12.128:8080/MavenSpring/usrs/mostrar/14", Usuarios.class, 200);
		Usuarios[] listado = rt.getForObject("http://192.168.12.128:8080/MavenSpring/usrs/mostrar", Usuarios[].class, 200);
